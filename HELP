...
private final JLabel lblAddHlp, lblViewHlp, lblDelHlp, lblUpdtHlp,
lblSrchHlp;
...
frameHelp.setIconImage(icon.getImage()); //setting
window icon
//setting up the frame
frameHelp.setSize(400, 580);
frameHelp.setLayout(new BorderLayout()); //frame
layout: Border Layout
frameHelp.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
//setting default close operation
frameHelp.setLocationRelativeTo(null); //to center the
window
frameHelp.setResizable(false); //disable window
resize
...
panelMain.setBackground(clrYellow); //background
color: Yellow
panelMain.setPreferredSize(new Dimension(400, 580));
//setting panel size
