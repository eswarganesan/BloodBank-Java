...
public class Donor {
private int id, age;
private String name, fathersName, mothersName, gender, weight,
bloodGroup, maritalStatus, nid, mobileNo, diseases, division, district, address;
private Date lastDonation;
private InputStream picture;
Donor() {
}
Donor(int age, String name, String fathersName, String mothersName, String
gender, String weight, String bloodGroup,
String maritalStatus, String nid, String mobileNo, String diseases, String
division, String district,
...
Donor(int id, String name, String gender, int age, String weight, String
bloodGroup, Object lastDonation,
