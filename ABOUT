...
frameAbout.setIconImage(icon.getImage()); //setting
window icon
//setting up the frame
frameAbout.setSize(400, 300);
frameAbout.setLayout(new BorderLayout()); //frame
layout: Border Layout
frameAbout.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
//setting default close operation
frameAbout.setLocationRelativeTo(null); //to center
the window
frameAbout.setResizable(false); //disable window
resize
